...
\\2. With regards to the second question, we will make use of the review date and company variables to observe how the expert reviews for different companies vary over time. Then using aesthetic parameters of fill and color with alpha values, we plan to gain a better understanding of what potential changes in characteristics have caused an upward or downward in the review ratings over time. We plan to create a time series plot in order to see how the expert reviews for chocolate will improve over time. We will use review_date on the x axis, and we will also incorporate variables such as company and rating in the plot as well.

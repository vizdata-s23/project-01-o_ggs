...
In this project, we aim to explore what characteristics (as identified by experts) of chocolate bars lead to the most successful chocolate bars and how expert opinions of these characteristics have changed over time. We found that companies that specialize in a cocoa percent range and get their cocoa beans from Central/ South America and Southeast Asia are the most successful. The data also suggests that experts have grown to highly rate chocolate with a high cocoa percentage over and American-based companies taking the lead in highly rated chocolate over the European counterparts as the years go on.

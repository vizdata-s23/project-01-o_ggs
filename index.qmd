...
#| fig.width: 10
#| fig.height: 11
#| fig-cap: Belgium and Switzerland specialize in a limited cocoa percentages which lead to more consistent 
...
# Can you also add an informative title/subtitle that includes how to use this graph?
world_df |>

...
The first plot shows quite a bit of variation between cocoa percentage to variation across countries. Across all the trend lines for the top 8 countries, we see a general decrease in rating as cocoa percentage increases. 
Belgium and Switzerland specialize in a limited cocoa percentages which lead to more consistent 

...
chocolate_merged1 <- chocolate_merged |>
  mutate(
    year_even = case_when(
      review_date == 2006 | review_date == 2007 ~ "2006",
      review_date == 2008 | review_date == 2009 ~ "2008",
      review_date == 2010 | review_date == 2011 ~ "2010",
      review_date == 2012 | review_date == 2013 ~ "2012",
      review_date == 2014 | review_date == 2015 ~ "2014",
      review_date == 2016 | review_date == 2017 ~ "2016"
    )
  ) |>
...
ggplot(chocolate_merged1, mapping = aes(x = cocoa_percent, y = avg_rating)) +
  geom_line() +
  geom_smooth(aes(color = year_even), se = FALSE) +
  facet_grid(year_even ~., scales = "free_y") + 
  theme_minimal() + 
  labs(x = "Percentage of Cocoa in Chocolate", 
       y = "Average Rating", title = "How well Chocolate Percentages are Rated", 
